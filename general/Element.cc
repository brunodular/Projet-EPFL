...
void Element::el_preced(Element* el) {
	el_preced_ = el;
}
...
//Constructeur
ElementDroit::ElementDroit(Vecteur3D pos_e,Vecteur3D pos_s,double r_section,SupportADessin* support,Element* el_suiv) : Element(pos_e, pos_s, r_section, support, el_suiv) {longueur_ = (pos_s_ - pos_e_).norme();}
