...
Il est cependant conseillé de ne ni mettre trop de particules à la fois, ou de ni trop bouger la "caméra" lorsqu'il y a trop de particules en mouvement. En effet, ceci ferait très probablement disparaître toutes les particules de l'accélérateur (cf. fichier conception pour plus d'informations).
