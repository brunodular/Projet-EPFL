...
class Particule {
	private:
		...
		static const double c;		//vitesse de la lumiere comme constante commune a toutes les particules
		static const double e;		//charge elementaire comme constante
		
	public:
		//Constructeurs
		Particule (Masse M, double Q,Vecteur3D pos=Vecteur3D (0.0, 0.0, 0.0), 
		Vecteur3D vt=Vecteur3D (0.0, 0.0, 0.0),Vecteur3D force=Vecteur3D (0.0, 0.0, 0.0), 
		double g=1.0, double E=0.0) 
		  : pos_(pos), v_(vt), M_(M), Q_(Q), E_(E), gamma_(g), force_(force) {}
